Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => 'https://github.com/traveloka/Texture.git', :tag => spec.version.to_s }
  ...
  spec.default_subspecs = 'Core', 'PINRemoteImage', 'Video', 'MapKit', 'AssetsLibrary', 'Photos', 'IGListKit', 'Yoga'
